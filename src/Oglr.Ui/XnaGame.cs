...
namespace Oglr
{
	public class XnaGame : Game, IGame
	{
		...
		public XnaGame( IMainForm mainForm )
		{
            ...
            Control fromHandle = Control.FromHandle(Window.Handle);
		    _xnaForm = (Form) fromHandle;
		    _xnaForm = (Form)Control.FromHandle(Window.Handle);

			_xnaForm.VisibleChanged += game1VisibleChanged;
			_xnaForm.Size = new Size(10, 10);
