...
namespace Oglr.Core.Controls
{
	public partial class LevelExplorerControl : UserControl
	{
		...
		const string LAYER_ICON_ACTIVE_NAME = @"Oglr.Core.Resources.icon_layer_active.png" ;
        const string LAYER_ICON_NONACTIVE_NAME = @"Oglr.Core.Resources.icon_layer_nonactive.png";
        const string LEVEL_ICON_NAME = @"Oglr.Core.Resources.icon_level.png";
